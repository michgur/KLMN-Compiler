...
//                st.enterScope();
//                String code = getChildren()[0].apply();
//                st.exitScope();
//                return code;
//            }
//        });
...
//                    for (AST ast : getChildren()) s.append(ast.apply());
//                    st.exitScope();
//                    return s.toString();
//                }
//            };
...
//                        st.addSymbol(name);
//                        return getChildren()[1].apply() + "pop #" + st.findSymbol(name) + '\n';
//                    }
//                });
//        factory.addProduction(A, new Symbol[] { identifier, assign, E }, c ->
//                new AST(c[1].getValue(), c[0], c[2]) {
//                    @Override public String apply() {
//                        return getChildren()[1].apply() + "pop #" + st.findSymbol(getChildren()[0].getValue().getValue()) + '\n';
//                    }
//                });
//        factory.addProduction(S, new Symbol[] { print, E }, c -> new AST(c[0].getValue(), c[1]) {
//            @Override public String apply() {
//                return getChildren()[0].apply() + "pop #1\nprint #1\n";
//            }
//        });
...
//            @Override public String apply() {
//                return getChildren()[0].apply() + "pop #0\nmul #0 -1\npush #0\n";
//            }
//        });
...
//            @Override public String apply() { return c[0].apply() + "pop #0\n"; }
//        });
...
//                    @Override public String apply() {
//                        st.enterScope();
//                        String init = getChildren()[0].apply();
//                        String condition = getChildren()[1].apply();
//                        String increment = getChildren()[2].apply();
//                        st.enterScope();
//                        String body = getChildren()[3].apply();
//                        st.exitScope();
//                        st.exitScope();
