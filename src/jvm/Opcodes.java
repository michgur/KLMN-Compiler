...
/* This interface has all the opcodes in the JVM instruction set and some utility methods */
public interface Opcodes
{
    ...
    /* Get the amount of operands this opcode required */
    static int getOperandsAmount(byte opcode)
    { return Opcodes.binaryOperators.contains(opcode) ? 2 : Opcodes.unaryOperators.contains(opcode) ? 1 : 0; }

    /* Get the type that this opcode pushed onto the stack */
    ...
    /* Get the opcode for a load instruction of type */
    ...
    /* Get the opcode for a store instruction of type */
    ...
    /* Get the opcode for a type conversion instruction */
    ...
    /* Get the opcode for a array store instruction of type */
    ...
    /* Get the opcode for a array load instruction of type */
    ...
    /* Byte Access flags used for Classes, Methods and Fields */
